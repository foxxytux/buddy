...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".buddy/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".buddy/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.buddy/agent/sessions)
