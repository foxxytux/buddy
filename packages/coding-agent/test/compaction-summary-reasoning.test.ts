...
import type { AssistantMessage, Model } from "@mariozechner/buddy-ai";
...
vi.mock("@mariozechner/buddy-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@mariozechner/buddy-ai")>();
	return {
		...actual,
