...
import { Agent, type AgentEvent, type AgentTool } from "@mariozechner/buddy-agent-core";
import { type AssistantMessage, type AssistantMessageEvent, EventStream, getModel } from "@mariozechner/buddy-ai";
