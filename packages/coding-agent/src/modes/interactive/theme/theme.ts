...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@foxxytux/buddy-tui";
...
const THEME_KEY = Symbol.for("@foxxytux/buddy-coding-agent:theme");
...
export function getSettingsListTheme(): import("@foxxytux/buddy-tui").SettingsListTheme {
	return {
