...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@mariozechner/buddy-tui";
...
const THEME_KEY = Symbol.for("@mariozechner/buddy-coding-agent:theme");
...
export function getSettingsListTheme(): import("@mariozechner/buddy-tui").SettingsListTheme {
	return {
