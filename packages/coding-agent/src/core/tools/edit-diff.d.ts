 ...
 */
export declare function applyEditsToNormalizedContent(
 ...
 */
export declare function generateDiffString(
	oldContent: string,
	newContent: string,
	contextLines?: number,
): {
 ...
 */
export declare function computeEditsDiff(
	path: string,
	edits: Edit[],
	cwd: string,
 ...
 */
export declare function computeEditDiff(
	path: string,
	oldText: string,
	newText: string,
	cwd: string,
