...
const MIGRATION_GUIDE_URL =
	"https://github.com/foxxytux/buddy/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/foxxytux/buddy/blob/main/packages/coding-agent/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.buddy/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.buddy/agent/ instead of
 * ~/.buddy/agent/sessions/<encoded-cwd>/. This migration moves them
