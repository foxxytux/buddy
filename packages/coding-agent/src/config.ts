...
export function getUpdateInstruction(packageName: string): string {
	...
	switch (method) {
		case "bun-binary":
			return `Download from: https://github.com/foxxytux/buddy/releases/latest`;
		case "pnpm":
...
export function getPackageDir(): string {
	...
	const envDir = process.env.BUDDY_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json buddyConfig)
// =============================================================================

const pkg = JSON.parse(readFileSync(getPackageJsonPath(), "utf-8"));

export const APP_NAME: string = pkg.buddyConfig?.name || "buddy";
export const CONFIG_DIR_NAME: string = pkg.buddyConfig?.configDir || ".buddy";
export const VERSION: string = pkg.version;

// e.g., PI_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
export const ENV_AGENT_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_DIR`;

const DEFAULT_SHARE_VIEWER_URL = "https://buddy.dev/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.BUDDY_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.buddy/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.buddy/agent/) */
