> buddy can create prompt templates. Ask it to build one for your workflow.
...
Buddy loads prompt templates from:

- Global: `~/.buddy/agent/prompts/*.md`
- Project: `.buddy/prompts/*.md`
- Packages: `prompts/` directories or `buddy.prompts` entries in `package.json`
