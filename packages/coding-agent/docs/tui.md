...
**Source:** [`@mariozechner/buddy-tui`](https://github.com/badlogic/buddy-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@mariozechner/buddy-tui";
...
```typescript
import { Container, type Focusable, Input } from "@mariozechner/buddy-tui";
...
Import from `@mariozechner/buddy-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@mariozechner/buddy-tui";
```
...
```typescript
import { matchesKey, Key } from "@mariozechner/buddy-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@mariozechner/buddy-tui";
...
```typescript
import { getMarkdownTheme } from "@mariozechner/buddy-coding-agent";
import { Markdown } from "@mariozechner/buddy-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@mariozechner/buddy-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@mariozechner/buddy-coding-agent";
import { DynamicBorder } from "@mariozechner/buddy-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@mariozechner/buddy-tui";
...
```typescript
import { BorderedLoader } from "@mariozechner/buddy-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@mariozechner/buddy-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@mariozechner/buddy-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@mariozechner/buddy-tui";
...
import { matchesKey, truncateToWidth } from "@mariozechner/buddy-tui";
