 ...
 *   buddy -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... buddy -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (buddy: ExtensionAPI) {
	buddy.registerProvider("custom-anthropic", {
