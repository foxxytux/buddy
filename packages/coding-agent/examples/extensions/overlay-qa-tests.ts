 ...
 *
 * Usage: buddy --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@foxxytux/buddy-coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@foxxytux/buddy-tui";
import { matchesKey, truncateToWidth, visibleWidth } from "@foxxytux/buddy-tui";
...
export default function (buddy: ExtensionAPI) {
	...
	buddy.registerCommand("overlay-animation", {
	...
	buddy.registerCommand("overlay-anchors", {
	...
	buddy.registerCommand("overlay-margins", {
	...
	buddy.registerCommand("overlay-stack", {
	...
	buddy.registerCommand("overlay-overflow", {
	...
	buddy.registerCommand("overlay-edge", {
	...
	buddy.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	buddy.registerCommand("overlay-maxheight", {
	...
	buddy.registerCommand("overlay-sidepanel", {
	...
	buddy.registerCommand("overlay-toggle", {
	...
	buddy.registerCommand("overlay-passive", {
	...
	buddy.registerCommand("overlay-focus", {
	...
	buddy.registerCommand("overlay-streaming", {
