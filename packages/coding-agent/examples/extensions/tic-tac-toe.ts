...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@foxxytux/buddy-coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@foxxytux/buddy-tui";
