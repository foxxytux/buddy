...
```bash
npm install @mariozechner/buddy-ai
```

TypeBox exports are re-exported from `@mariozechner/buddy-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@mariozechner/buddy-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@mariozechner/buddy-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@mariozechner/buddy-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@mariozechner/buddy-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@mariozechner/buddy-ai';
...
```typescript
import { getModel, stream } from '@mariozechner/buddy-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@mariozechner/buddy-ai';
...
```typescript
import { Model, stream } from '@mariozechner/buddy-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@mariozechner/buddy-ai';
...
```typescript
import { getModel, complete, Context } from '@mariozechner/buddy-ai';
...
```typescript
import { Context, getModel, complete } from '@mariozechner/buddy-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@mariozechner/buddy-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@mariozechner/buddy-ai';
...
```bash
npx @mariozechner/buddy-ai login              # interactive provider selection
npx @mariozechner/buddy-ai login anthropic    # login to specific provider
npx @mariozechner/buddy-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@mariozechner/buddy-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@mariozechner/buddy-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@mariozechner/buddy-ai/oauth';
...
```typescript
import { getModel, complete } from '@mariozechner/buddy-ai';
import { getOAuthApiKey } from '@mariozechner/buddy-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@mariozechner/buddy-ai`
